...
import com.chepra.mvptodo.adapters.TodoAdapter
import com.chepra.mvptodo.main.mvpFragmentsPack.FragPage
 ...
 */
class FragDone : Fragment(),FragmentListinner,FragsMVP.View,DialogListinner{
    ...
    @Inject
    lateinit var presenter: FragsMVP.Presenter


    var presenterCheck: Boolean = false


    fun  updatelist(){
        Log.i("testeteste","that's worked guy")
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = TodoAdapter(FragToDo(),this,2,presenter)
    ...
    override fun onResume() {
        ...
        presenter.setPage(FragPage.WORKED_DONE)
    }
    ...
    override fun setTask(taskModel: List<TaskModel>) {
