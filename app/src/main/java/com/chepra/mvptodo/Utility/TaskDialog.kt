...
import com.chepra.mvptodo.main.mvpPackage.MainPresenter

class TaskDialog(context: Activity,presenter: MainMVP.Presenter): View.OnClickListener
{
    val presenter: MainMVP.Presenter
   ...
   lateinit var ll_first: LinearLayout
    ...
    fun ShowTaskDialog()
    {
        ...
        btn_save.setOnClickListener {
            presenter.dialog_btnSaveClicked(ed_tite.text.toString(),ed_description.text.toString(),labelValue)
        }
